...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Future<void> _loadBiometric() async {
    ...
    if (mounted) setState(() { _biometric = v; _loadingBio = false; });
  }

  Future<void> _setBiometric(bool v) async {
    if (v) {
      final auth = LocalAuthentication();
      final ok   = await auth.canCheckBiometrics || await auth.isDeviceSupported();
      if (!ok && mounted) {
          ...
          child: ListView(
            ...
            children: [
              ...
              _Card(child: Column(children: [
                _SettingsRow(
                  icon: Iconsax.award, label: 'Mi Progreso',
                  sublabel: 'Nivel y logros', color: _kBlue,
                  onTap: () => Navigator.push(context,
                      MaterialPageRoute(builder: (_) => const ProfileScreen())),
                ),
                _Divider(),
                _SettingsRow(
                  icon: Iconsax.moon, label: 'Apariencia',
                  sublabel: _themeLabel(tp.themeMode), color: _kTeal,
                ...
                _Divider(),
                _SettingsRow(
                  icon: Iconsax.grid_3, label: 'Categorías',
                  sublabel: 'Gestionar categorías', color: _kGreen,
                  onTap: () => Navigator.push(context,
              ...
              const SizedBox(height: 28),
              _Card(child: _SettingsRow(
                icon: Iconsax.logout, label: 'Cerrar Sesión',
                color: _kRed, labelColor: _kRed,
                showChevron: false, onTap: _openLogoutSheet,
              )),
            ],
          ),
        ),
...
class _SectionLabel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Text(text, style: _T.label(11, w: FontWeight.w700,
          c: onSurf.withOpacity(0.35))),
    );
  }
}
...
class _SettingsRow extends StatefulWidget {
  ...
  const _SettingsRow({
    ...
    required this.onTap,
    this.sublabel, this.labelColor, this.trailing, this.showChevron = true,
  });
    ...
    return Padding(
      ...
      child: Row(children: [
        Container(
          ...
          child: Center(child: Icon(Iconsax.finger_scan,
        ...
        builder: (_, v, __) => Container(
          ...
          child: Align(
            alignment: Alignment.lerp(
                Alignment.centerLeft, Alignment.centerRight, v)!,
            child: Container(
              width: 26, height: 26,
              decoration: BoxDecoration(
      ...
      child: Padding(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          Container(width: 36, height: 4,
              ...
              decoration: BoxDecoration(color: onSurf.withOpacity(0.18),
                  borderRadius: BorderRadius.circular(2))),
          Text('Apariencia', style: _T.label(13,
...
class _ThemeRow extends StatefulWidget {
  ...
  final VoidCallback onTap;
  const _ThemeRow({required this.label, required this.icon, required this.onTap,
      required this.selected, required this.isFirst, required this.isLast});
  @override State<_ThemeRow> createState() => _ThemeRowState();
}
      ...
      child: AnimatedBuilder(
        ...
        builder: (_, __) => Container(
          ...
          child: Column(children: [
            ...
            if (!widget.isLast)
              Padding(padding: const EdgeInsets.only(left: 52),
          ...
          Container(
            ...
            child: Column(children: [
              Container(
                ...
                decoration: BoxDecoration(color: _kRed.withOpacity(0.12),
              ...
              Row(children: [
                Expanded(child: _InlineBtn(label: 'Cancelar', color: onSurf,
                    onTap: () => Navigator.pop(context))),
                const SizedBox(width: 10),
                Expanded(child: _InlineBtn(
                    label: 'Cerrar sesión', color: _kRed, impact: true,
                    onTap: () async {
                      Navigator.pop(context);
                      await onConfirm();
                    })),
