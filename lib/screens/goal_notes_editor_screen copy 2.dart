  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            // ========= CORRECCIÓN FINAL: ELIMINAR SingleChildScrollView =========
            AnimatedSize(
              ...
              child: _isToolbarVisible
                  ? Container(
                      width:
                          double.infinity, // Aseguramos que ocupe todo el ancho
            ...
            // ========= EDITOR FUNCIONAL (TU CÓDIGO INTACTO) =========
            Expanded(
              child: LayoutBuilder(
